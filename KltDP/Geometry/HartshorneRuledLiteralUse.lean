...
namespace KltDP.Geometry.HartshorneRuledLiteralUse
...
theorem decomposition_at
  ...
  KltDP.Literature.Hartshorne.ruled_surface_picard_literal k X hX C c hCdim hCreg π hbase hsurj hfib σ hσ
...
theorem genera_at :
  ...
  KltDP.Literature.Hartshorne.ruled_surface_genus_literal k X hX C c hCdim hCreg π hbase hsurj hfib σ hσ

end KltDP.Geometry.HartshorneRuledLiteralUse

#check @KltDP.Geometry.HartshorneRuledLiteralUse.decomposition_at
#check @KltDP.Geometry.HartshorneRuledLiteralUse.genera_at
#print axioms KltDP.Geometry.HartshorneRuledLiteralUse.decomposition_at
#print axioms KltDP.Geometry.HartshorneRuledLiteralUse.genera_at
