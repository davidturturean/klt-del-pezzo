...
/-!
# The original left transported factor with all generic arguments explicit
...
def leftTransportedFactorIso (p : PrimeSpectrum (SmoothPointBlowupChartBasis.chartRing k φ)) :=
  native_pullback_factor_iso%[
    SmoothPointBlowupNativeRefinedFactors.leftFactorIso k φ hφ p,
