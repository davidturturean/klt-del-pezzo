...
/-!
The actual projective normal factor of one generated complete system retains its
...
/-- An actual projective normal proper ample factor contracting exactly the original
degree-zero primes, with its original geometric and point fiber connectedness. -/
theorem exists_projective_normal_factor_with_prime_criterion
  ...
  refine ⟨m, hm, target X.structureMorphism (power L m) hpos hG,
    structureMorphism X.structureMorphism (power L m) hpos hG,
    structureMorphism_isProjective X.structureMorphism (power L m) hpos hG,
    structureMorphism_isProper X.structureMorphism (power L m) hpos hG,
