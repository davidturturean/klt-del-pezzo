...
/-!
# The original even selection constructs blowdowns preserving the full pairing
...
that unchanged surface, preserving every original disjoint curve and
all pairwise intersections among those surviving original curves.
-/
...
local instance evenSelectionIntersectionBlowdownsSeparated : S.toScheme.IsSeparated := surfaceSeparated S
local instance evenSelectionIntersectionBlowdownsMonoidal : MonoidalCategory S.toScheme.Modules :=
...
theorem exists_original_cover_ramification_blowdowns_preserving_intersections
  ...
  exact S.exists_selectedRamification_blowdowns_preserving_intersections
    N E hE L e h2 hred hne hIJ hdisj hcurves hweil hP1 hself

end KltDP.Geometry.NormalProjectiveSurface

#print axioms KltDP.Geometry.NormalProjectiveSurface.exists_original_cover_ramification_blowdowns_preserving_intersections
